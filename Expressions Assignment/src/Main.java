...
public class Main {
    public static void main(String args[]){
        ...
        */
        ...
        System.out.println(3 + 81f/5);
        System.out.println(3 + 16.2f);
        System.out.println(19.2f);

        //Expression 4
        System.out.println((9 % 4) - 8 + Math.pow(2,3) / 8 + (Math.sqrt(81) / 3));
        System.out.println( 1 - 8 + Math.pow(2,3) / 8 + (Math.sqrt(81) / 3));
        System.out.println( 1 - 8 + Math.pow(2,3) / 8 + (9f / 3));
        System.out.println( 1 - 8 + Math.pow(2,3) / 8 + 3f);
        System.out.println( 1 - 8 + 8f / 8 + 3f);
        System.out.println( 1 - 8 + 1f + 3f);
        ...
        System.out.println((10 * Math.sin(45) + 2) - Math.pow(5f, 3));
        System.out.println((10 * Math.sin(45) + 2) - 125);
        System.out.println((10 * 0.8509035245341184 + 2) - 125f);
        System.out.println((8.509035245341184 + 2) - 125f);
        System.out.println(10.509035245341184 - 125f);
        System.out.println(10.509035245341184 - 125f);
